...
const features = [
  { icon: Award,  title: "Premium Quality", description: "Crafted with the finest materials and attention to detail" },
  { icon: Truck,  title: "Free Delivery",    description: "Complimentary delivery and installation services" },
  { icon: Shield, title: "10 Year Warranty", description: "Extended warranty coverage on all our products" },
  { icon: Users,  title: "Expert Support",   description: "Professional consultation and design assistance" },
];
